...
const (
	...
	PaymentService_ListPaymentsByAccount_FullMethodName = "/payment.v1.PaymentService/ListPaymentsByAccount"
	PaymentService_ListPaymentsByClient_FullMethodName  = "/payment.v1.PaymentService/ListPaymentsByClient"
)
...
func (c *paymentServiceClient) ListPaymentsByAccount(ctx context.Context, in *ListPaymentsByAccountRequest, opts ...grpc.CallOption) (*ListPaymentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *paymentServiceClient) ListPaymentsByClient(ctx context.Context, in *ListPaymentsByClientRequest, opts ...grpc.CallOption) (*ListPaymentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListPaymentsResponse)
	err := c.cc.Invoke(ctx, PaymentService_ListPaymentsByClient_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPaymentServiceServer) ListPaymentsByAccount(context.Context, *ListPaymentsByAccountRequest) (*ListPaymentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPaymentsByAccount not implemented")
}
func (UnimplementedPaymentServiceServer) ListPaymentsByClient(context.Context, *ListPaymentsByClientRequest) (*ListPaymentsResponse, error) {
...
func _PaymentService_ListPaymentsByClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListPaymentsByClientRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentServiceServer).ListPaymentsByClient(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PaymentService_ListPaymentsByClient_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ListPaymentsByClient(ctx, req.(*ListPaymentsByClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _PaymentService_ListPaymentsByClient_Handler,
		},
	},
