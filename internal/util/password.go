...
// GenerateSalt returns a base64-encoded random salt
...
// HashPassword computes PBKDF2-SHA256(password, salt, 100k, 32)
...
// VerifyPassword checks password against the stored salt and hash
...
// ValidatePasswordPolicy enforces: 8–32 chars, ≥2 digits, ≥1 uppercase, ≥1 lowercase
